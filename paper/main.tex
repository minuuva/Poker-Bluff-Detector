...
normalization and explicit bet-size leakage controls.
...
severe degradation across domains \cite{guo2023dolos}. Our result extends
this pattern to a naturalistic, high-stakes, repeated-game setting with
...
identifiable imagery, and publish code, derived features, timestamps,
and the preregistrations rather than clips. Pipeline, analysis code,
